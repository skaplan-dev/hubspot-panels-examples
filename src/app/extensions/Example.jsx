  ...
  return (
    <TableCell>
      <Flex align="center" direction="row" justify="between">
        <Text>{text}</Text>
        <Link onClick={async (__, reactions) => {
          onClick();
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <CellWithDetails text="Car Salesman" onClick={() => setSelected('Tim Robinson')} />
          </TableRow>
          <TableRow>
            <TableCell>Patti Harrison</TableCell>
            <CellWithDetails text="Tables (vendor)" onClick={() => setSelected('Patti Harrison')} />
          </TableRow>
          <TableRow>
            <TableCell>Sam Richardson</TableCell>
            <CellWithDetails text="Show host" onClick={() => setSelected('Sam Richardson')} />
          </TableRow>
          <TableRow>
            <TableCell>Ruben Rabasa</TableCell>
            <CellWithDetails text="Car imagineer" onClick={() => setSelected('Ruben Rabasa')} />
          </TableRow>
        </TableBody>
      </Table>
    </>
